...
$c_Lobservatory_Interaction2$.prototype.init___ = (function() {
  ...
  this.colors$1 = $as_sci_List($s_sc_TraversableLike$class__to__sc_TraversableLike__scg_CanBuildFrom__O(xs, cbf));
  return this
});
$c_Lobservatory_Interaction2$.prototype.yearSelection__Lobservatory_Signal__Lobservatory_Signal__Lobservatory_Signal = (function(selectedLayer, sliderValue) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(selectedLayer$3, sliderValue$1) {
    return (function() {
      var selectedYear = $uI(sliderValue$1.apply__O());
      var bounds = $as_Lobservatory_Layer(selectedLayer$3.apply__O()).bounds$1;
      var y = bounds.start$4;
      var x = ((selectedYear > y) ? selectedYear : y);
      var y$1 = bounds.end$4;
      return ((x < y$1) ? x : y$1)
    })
...
$c_Lobservatory_Interaction2$.prototype.availableLayers__sc_Seq = (function() {
  return $as_sc_Seq($m_sc_Seq$().apply__sc_Seq__sc_GenTraversable(new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_Lobservatory_Layer().init___Lobservatory_LayerName__sc_Seq__sci_Range($m_Lobservatory_LayerName$Temperatures$(), this.colors$1, new $c_sci_Range().init___I__I__I(2010, 2015, 1)), new $c_Lobservatory_Layer().init___Lobservatory_LayerName__sc_Seq__sci_Range($m_Lobservatory_LayerName$Deviations$(), this.colors$1, new $c_sci_Range$Inclusive().init___I__I__I(1990, 2015, 1))])))
});
$c_Lobservatory_Interaction2$.prototype.yearBounds__Lobservatory_Signal__Lobservatory_Signal = (function(selectedLayer) {
  $m_Lobservatory_Signal$();
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(selectedLayer$2) {
    return (function() {
      return $as_Lobservatory_Layer(selectedLayer$2.apply__O()).bounds$1
    })
  })(selectedLayer));
  return new $c_Lobservatory_Signal().init___F0(expr)
});
$c_Lobservatory_Interaction2$.prototype.layerUrlPattern__Lobservatory_Signal__Lobservatory_Signal__Lobservatory_Signal = (function(selectedLayer, selectedYear) {
  $m_Lobservatory_Signal$();
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(selectedLayer$1, selectedYear$1) {
    return (function() {
      var layer = $as_Lobservatory_Layer(selectedLayer$1.apply__O());
      var name = layer.layerName$1;
      var year = $uI(selectedYear$1.apply__O());
      var x = $m_Lobservatory_LayerName$Temperatures$();
      if ((x === name)) {
        return new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["target/", "/", "/{z}/{x}-{y}.png"])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lobservatory_LayerName$Temperatures$().id$1, year]))
      } else {
        var x$3 = $m_Lobservatory_LayerName$Deviations$();
        if ((x$3 === name)) {
          return new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["target/", "/", "/{z}/{x}-{y}.png"])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lobservatory_LayerName$Deviations$().id$1, year]))
        } else {
...
$c_Lobservatory_Interaction2$.prototype.caption__Lobservatory_Signal__Lobservatory_Signal__Lobservatory_Signal = (function(selectedLayer, selectedYear) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(selectedLayer$4, selectedYear$2) {
    return (function() {
      var layer = $as_Lobservatory_Layer(selectedLayer$4.apply__O());
      var name = layer.layerName$1;
      var year = $uI(selectedYear$2.apply__O());
      var x = $m_Lobservatory_LayerName$Temperatures$();
      if ((x === name)) {
        return new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["Temperatures (", ")"])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([year]))
      } else {
        var x$3 = $m_Lobservatory_LayerName$Deviations$();
        if ((x$3 === name)) {
          return new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["Deviations (", ")"])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([year]))
        } else {
          throw new $c_s_MatchError().init___O(name)
        }
      }
