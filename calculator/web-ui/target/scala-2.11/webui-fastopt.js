...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  _eval: while (true) {
    ...
    if ($is_Lcalculator_Literal(x1)) {
      ...
      var name = x7.name$2;
      var referenceExpr = this.getReferenceExpr__p1__T__sci_Map__Lcalculator_Expr(name, references);
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, delta$1) {
    return (function() {
      if (($uD(delta$1.apply__O()) < 0)) {
        ...
        var d = $uD($g.Math.sqrt(a$1));
        var array = [(((-$uD(b$2.apply__O())) + d) / (2 * $uD(a$2.apply__O()))), (((-$uD(b$2.apply__O())) - d) / (2 * $uD(a$2.apply__O())))];
